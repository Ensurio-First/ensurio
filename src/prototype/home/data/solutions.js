...
export const solutionPages = [
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'h2', text: 'What we take off your hands' },
      { type: 'steps', items: [
        { title: 'Strategy & documentation', text: 'We build the claim properly from day one, so it is not weakened before anyone reads it.' },
        { title: 'Insurer liaison', text: 'Every call, email and deadline goes through us instead of through you.' },
